 ...
 * @since 1.0
 */
class Manageredit extends \fecshop\app\appadmin\modules\Catalog\block\productinfo\Manageredit
{
    public $_saveUrl;
    protected $_attr;
     ...
     */
    protected $_attrBlockName = '\fecbbc\app\appadmin\modules\Catalog\block\productinfo\index\Attr';
    ...
    protected function initParamType()
    {
        ...
        //status
        $this->_param['status'] = $this->_param['status'] ? (int) ($this->_param['status']) : 0;
        // 供应商
