...
namespace fecbbc\app\appadmin\modules\Catalog\block\productinfo\index;
 ...
 * @since 1.0
 */
class BatchAttr extends \fecshop\app\appadmin\modules\Catalog\block\productinfo\index\BatchAttr
{
    ...
    public function getBaseInfo()
    {
        return [
            ...
            [
                'label' => Yii::$service->page->translate->__('Product Spu'),
                'name'  => 'spu',
                'display' => [
                    'type' => 'inputString',
                    'lang' => false,
