...
namespace fecbbc\app\appadmin\modules\Catalog\block\productreview;
 ...
 * @since 1.0
 */
class Manageredit extends \fecshop\app\appadmin\modules\Catalog\block\productreview\Manageredit
{
    public $_saveUrl;
    ...
    public function getEditArr()
    {
        ...
        return [
            ...
            [
                ...
                'display' => [
                    'type' => 'select',
                    'data' => $this->getActiveSupplierArr(),
                ],
                'require' => 1,
                'default' => 0,
            ],
    ...
    public function save()
    {
        ...
        $this->_param['audit_user'] = (int)$this->_param['bdmin_user_id'];
        $this->_param['audit_date'] = time();
        $this->_param['bdmin_user_id'] = (int)$this->_param['bdmin_user_id'];
