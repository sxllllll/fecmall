...
namespace fecbbc\app\appadmin\modules\Catalog\block\productupload;
...
class Manager 
{
    ...
    public function saveProduct($one)
    {
        ...
        $bdminModel = Yii::$service->bdminUser->bdminUser->getByUsername($bdmin_user);
        $bdminId = $bdminModel['id'];
        //echo $bdminId;exit;
        ...
        $productArr['bdmin_user_id'] = $bdminId;
