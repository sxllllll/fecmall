...
namespace fecbbc\app\appadmin\modules\Catalog\controllers;
 ...
 * @since 1.0
 */
class ProductinfoController extends \fecshop\app\appadmin\modules\Catalog\controllers\ProductinfoController
{
    public $enableCsrfValidation = true;
    public $blockNamespace = 'fecbbc\\app\\appadmin\\modules\\Catalog\\block';
    ...
    {
        $this->getBlock('managerbatchedit')->bulkenable();
    }

    public function actionBulkdisable()
    {
        $this->getBlock('managerbatchedit')->bulkdisable();
    }
