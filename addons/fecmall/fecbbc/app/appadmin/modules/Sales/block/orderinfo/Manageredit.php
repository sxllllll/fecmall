 ...
 * @since 1.0
 */
class Manageredit extends \fecshop\app\appadmin\modules\Sales\block\orderinfo\Manageredit
{
    public $_saveUrl;
    ...
    public function getViewOrderInfo($order_info){
        ...
        $bdminUserIdArr = $this->getActiveSupplierArr();
        //var_dump($orderStatusArr);exit;
        $order_info['order_status_options'] = $this->getOptions($orderStatusArr, $order_info['order_status']);
        $order_info['bdmin_user_id_options'] = $this->getNOptions($bdminUserIdArr, $order_info['bdmin_user_id']);
    ...
    public function getNOptions($orderStatusArr,$order_status){
    ...
    public function exportExcel(){
        ...
        $excelArr[] = [
            ...
            Yii::$service->page->translate->__('City Area'),
                ...
                foreach ($orderItemColl as $orderItem) {
                    ...
                    if (isset($orderCollArr[$order_id])) {
                        ...
                        $excelArr[] = [
                            ...
                            $order['customer_address_state'], $order['customer_address_city'], $order['customer_address_area'], $order['customer_address_zip'], 
