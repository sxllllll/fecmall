...
namespace fecbbc\app\appadmin\modules\Sales\block\refundbdmin;
...
class Manager extends AppadminbaseBlock implements AppadminbaseBlockInterface
{
    ...
    { 
         ...
         * edit data url
         */
        $this->_editUrl = CUrl::getUrl('sales/refundbdmin/manageredit');
        /*
         * delete data url
         */
    ...
    public function getTableTbodyHtml($data)
    {
        ...
        foreach ($data as $one) {
            ...
            $str .= '<td> 
						<a title="' . Yii::$service->page->translate->__('View') . '" target="dialog" class="btnEdit" mask="true" drawable="true" width="1200" height="680" href="'.$this->_editUrl.'?id='.$one['id'].'" ><i class="fa fa-eye"></i></a>
