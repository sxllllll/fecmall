...
namespace fecbbc\app\appadmin\modules\Sales\block\returnlist;
...
class Manager extends AppadminbaseBlock implements AppadminbaseBlockInterface
{
    ...
    { 
         ...
         * edit data url
         */
        $this->_editUrl = CUrl::getUrl('sales/returnlist/manageredit');
        /*
         * delete data url
         */
        $this->_orderUrl = CUrl::getUrl('sales/orderinfo/manageredit');
    ...
    { 
        ...
        $data = [
            ...
            [    // selecit的Int 类型
                ...
                'value' => Yii::$service->order->afterSale->getAllReturnStatusArr(),
            ],
    ...
    public function getTableTbodyHtml($data)
    {
        ...
        foreach ($data as $one) {
            ...
            $str .= '<td> 
						<a title="' . Yii::$service->page->translate->__('View') . '" target="dialog" class="btnEdit" mask="true" drawable="true" width="1200" height="680" href="'.$this->_editUrl.'?id='.$one['id'].'" ><i class="fa fa-edit"></i></a>
						<a title="' . Yii::$service->page->translate->__('View') . '" target="dialog" class="btnEdit" mask="true" drawable="true" width="1200" height="680" href="'.$this->_orderUrl.'?order_id='.$one['order_id'].'" ><i class="fa fa-eye"></i></a>
