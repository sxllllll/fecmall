...
namespace fecbbc\app\appadmin\modules\Supplier\block\account;
    ...
    public function getEditArr(){
        ...
        return [
            ...
            [
             ...
             [
                'label'=> Yii::$service->page->translate->__('电话'),
                'name'=>'telephone',
                'require' => 0,
                'display'=>[
                    'type' => 'inputString',
             ...
             [
                'label'=> Yii::$service->page->translate->__('税点'),
                'name'=>'tax_point',
                'require' => 0,
                'display'=>[
                    'type' => 'inputString',
            ...
            [
                'label'=> Yii::$service->page->translate->__('发票要求'),
                'name'=>'invoice',
                'require' => 0,
                'display'=>[
                    'type' => 'inputString',
             ...
             [
                'label'=> Yii::$service->page->translate->__('授权品牌'),
