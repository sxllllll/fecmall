...
namespace fecbbc\app\appapi\modules;

use Yii;
use yii\filters\auth\CompositeAuth;
use yii\filters\auth\HttpBasicAuth;
use yii\filters\auth\HttpBearerAuth;
use fecbbc\yii\filters\auth\AppapiQueryParamAuth;  
 ...
 * @since 1.0
 */
class AppapiTokenController extends \fecshop\app\appapi\modules\AppapiTokenController
{
