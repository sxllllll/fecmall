 ...
 * @since 1.0
 */
class AppbdminbaseBlock extends BaseObject
{
    /**
    ...
    {
        parent::init();
        if (!($this instanceof AppbdminbaseBlockInterface)) {
            echo  'Managere  must implements fecbbc\app\appbdmin\interfaces\base\AppbdminbaseBlockInterface';
            exit;
        }
