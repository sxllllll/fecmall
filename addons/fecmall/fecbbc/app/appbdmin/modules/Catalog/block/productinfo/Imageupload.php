        ...
        foreach ($_FILES as $FILE) {
            ...
            if (is_array($saveImgInfo) && !empty($saveImgInfo)) {
                ...
                $img_str .= '<tr class="p_img" rel="'.$rel_index.'" style="border-bottom:1px solid #ccc;">
								...
								<td style="width:220px;text-align:center;"><input style="height:10px;" type="text" class="image_label" name="image_label"  /></td>
								<td style="width:220px;text-align:center;"><input style="height:10px;" type="text" class="sort_order"  name="sort_order"  /></td>
