...
//use fecbbc\app\appbdmin\modules\Catalog\helper\Product as ProductHelper;
use Yii;
...
class Index extends AppbdminbaseBlock implements AppbdminbaseBlockInterface
{
     ...
     */
    protected $_productHelperName = '\fecbbc\app\appbdmin\modules\Catalog\helper\Product';
    ...
    public function getTableTbodyHtml($data)
    {
        ...
        foreach ($data as $one) {
            ...
            $str .= '<td>
                    ...
                    // 产品复制按钮去除 	<a style="margin:3px 0 0" title="' . Yii::$service->page->translate->__('Copy')  . '" target="dialog" class="btnEdit" mask="true" drawable="true" width="1200" height="680" href="'.$this->_copyUrl.'&'.$this->_primaryKey.'='.$one[$this->_primaryKey].'" ><span><i class="fa fa-copy"></i></span></a>
