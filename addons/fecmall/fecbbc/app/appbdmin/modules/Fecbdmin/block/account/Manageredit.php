...
namespace fecbbc\app\appbdmin\modules\Fecbdmin\block\account;
...
class Manageredit extends AppbdminbaseBlockEdit implements AppbdminbaseBlockEditInterface
{
    ...
    {
        $this->_saveUrl = CUrl::getUrl('fecbdmin/account/managereditsave');
        parent::init();
    }
    ...
    public function getLastData(){
        ...
        return [
            ...
            'role_ids'=>$role_ids,
            'saveUrl' => CUrl::getUrl('fecbdmin/account/managereditsave'),
        ];
    }
