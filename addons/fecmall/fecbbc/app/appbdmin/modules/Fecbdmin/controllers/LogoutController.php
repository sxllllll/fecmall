...
class LogoutController extends Controller
{
    ...
    {
        $currentLang = Yii::$service->bdmin->getCurrentLangCode();
        $islogout = Yii::$app->request->post('islogout');
        if (!$islogout) {
            Yii::$service->admin->systemLog->save();
            Yii::$service->url->redirectByUrlKey("/fecbdmin/login/index", ['lang' => $currentLang]);
        }
        ...
        //$this->redirect("/fecbdmin/login/index",200)->send();
    }
