...
namespace fecbbc\app\appbdmin\modules\Sales\block\orderedit;
...
class Manager extends AppbdminbaseBlock implements AppbdminbaseBlockInterface
{
    ...
    public function init()
    {
         ...
         * edit data url
         */
        $this->_editUrl = CUrl::getUrl('sales/orderedit/manageredit');
        /*
         * delete data url
         */
        $this->_deleteUrl = CUrl::getUrl('sales/orderedit/managerdelete');
        
        $this->_exportExcelUrl = CUrl::getUrl('sales/orderedit/managerexport');
        /*
    ...
    { 
        $orderStatus = [
            Yii::$service->order->payment_status_pending => Yii::$service->page->translate->__(Yii::$service->order->payment_status_pending),
        ];
