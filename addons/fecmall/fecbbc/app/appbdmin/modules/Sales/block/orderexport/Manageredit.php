...
namespace fecbbc\app\appbdmin\modules\Sales\block\orderexport;
        ...
        if (!empty($order_arr)) {
            ...
            $orderFilter = [
               ...
               'where'			=> [
                   ...
                   [ 'in', 'order_status', Yii::$service->order->info->orderStatusProcessingOrderAcceptArr],
                   [ 'in', 'order_operate_status', Yii::$service->order->info->orderOperateStatusProcessingOrderAcceptArr],
