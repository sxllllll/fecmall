...
namespace fecbbc\app\appbdmin\modules\Sales\block\returnrefund;
...
class Manager extends AppbdminbaseBlock implements AppbdminbaseBlockInterface
{
    ...
    { 
         ...
         * delete data url
         */
        $this->_auditAcceptUrl = CUrl::getUrl('sales/returnrefund/manageraccept');
    ...
    { 
        $returnStatus = [
            Yii::$service->order->afterSale->after_sale_status_return_refund => Yii::$service->page->translate->__(Yii::$service->order->afterSale->after_sale_status_return_refund),
        ];
        $data = [
