...
<form data-v-5cb71550="" class="el-form login-form el-form--label-left" autocomplete="on" action="<?= CUrl::getUrl('fecbdmin/login/index', ['lang' => $currentLangCode]); ?>" method="post">
    <?php echo CRequest::getCsrfInputHtml();  ?>
    <div data-v-5cb71550="" class="title-container">
        <h3 data-v-5cb71550="" class="title"><?= Yii::$service->page->translate->__('FECMALL BDMIN'); ?>  </h3>
