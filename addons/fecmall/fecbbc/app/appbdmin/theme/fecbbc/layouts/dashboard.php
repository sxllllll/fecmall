...
$currentLangCode = Yii::$service->bdmin->getCurrentLangCode();
...
$logoPath = $this->assetManager->publish('@fecbbc/app/appbdmin/theme/fecbbc/assets/images/fecmall_logo.png');
?>
...
<head>
    ...
    <?= Html::csrfMetaTags() ?>
    <title><?= $this->title ? Html::encode($this->title) : Yii::$service->page->translate->__('FecMall bdmin Manager System') ?></title>
		...
		<div id="leftside">
			...
			<div id="sidebar">
				...
				<div class="accordion" fillSpace="sidebar">
					...
					<?= Yii::$service->bdmin->menu->getLeftMenuHtml();  ?>
				</div>
			</div>
		</div>
		<div id="container">
			<div id="navTab" class="tabsPage" style="position: relative;">
                ...
                <div class="headerNav" style="position: absolute;right: 25px; top: 0; width: 200px;  height: 30px; z-index: 99;">
                        <span style="font-size:14px;line-height: 40px;  color: #97a8be;   display: block;   height: 21px;  position: absolute; right: 125px; top: 0px;  z-index: 31; width: 150px;">
                    ...
                    <a style="font-size:14px; line-height: 40px;color:#97a8be; display: block; height: 40px;position: absolute; right: 5px;top: 0;z-index: 31;"
                       doPost
                       href='javascript:doPost("<?= Yii::$service->url->getUrl("fecbdmin/logout") ?>", {"<?= CRequest::getCsrfName() ?>": "<?= CRequest::getCsrfValue() ?>", "islogout": "1"}) '>
				...
				<div class="navTab-panel tabsPageContent layoutBox">
					<div class="page unitBox">
                            ...
                            $recentStatisticsInfo = Yii::$service->systemhelper->getRecentBdminStatisticsInfo($bdminUserId );
                        ?>
                            ...
                            <?php list($orderAmount, $orderCount) = Yii::$service->order->getBdminUserPreMonthOrder($day, $bdminUserId); ?>
