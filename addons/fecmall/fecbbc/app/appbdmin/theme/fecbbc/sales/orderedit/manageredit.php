						...
						<p class="edit_p">
							...
							<?php
                                ...
                                if ($order_operate_status != Yii::$service->order->operate_status_normal) {
                                    $str = Yii::$service->page->translate->__($order_operate_status);
                                } else {
                                    $str = Yii::$service->page->translate->__($order_status);
                                }
                            ?>
                            <span><?= $str ?></span>
                        </p>
							...
							<tbody class="odd">
								<?php if(is_array($order['products']) && !empty($order['products'])){  ?>
									...
									<tr id="order-item-row" class="border first">	
										...
										<td class="a-right">
											<span class="price-excl-tax" style="display:block;width:120px;">
												<span class="cart-price">
													<span class="price"><?= $symbol ?>
                                                        <input style="float:none;width:60px;"  type="text" name="editForm[products][<?= $product['item_id'] ?>]" value="<?= Format::price($product['price']); ?>" />                
												</span>
											</span>
											<br>
										</td>
