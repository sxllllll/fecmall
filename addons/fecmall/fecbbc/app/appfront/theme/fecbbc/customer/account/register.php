...
<div class="login-page passport-page yoho-page clearfix">
    ...
    <form id="register-form" action="<?= Yii::$service->url->getUrl('customer/account/register'); ?>" method="post" >
            ...
            <ul class="login-ul">
                <div class="desktop-login">
                    ...
                    <li class="relative password-login ">
                        <input id="phone" name="editForm[phone]" class="account input va " type="text" placeholder="<?= Yii::$service->page->translate->__('User Phone') ?>">
                    ...
                    <li class="relative confirmation-login ">
                        <input id="confirmation" name="editForm[confirmation]" class="confirmation input va " type="password" placeholder="<?= Yii::$service->page->translate->__('Confirm Password') ?>">
