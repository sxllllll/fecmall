...
namespace fecbbc\app\apphtml5\modules\Catalog\block\shop;
...
class Index
{
    ...
    public function getLastData()
    {
        ...
        $home_top_banner = Yii::$app->store->bdminGet($bdmin_user_id, 'bdmin_config', 'home_h5_top_banner');
        $bdmin_user_id = Yii::$app->request->get('bdmin_user_id');
        ...
        if ($bdmin_logo) {
            ...
            $logoImgUrl = Yii::$service->image->getImgUrl('addons/fecbbc/h5/logo_white.png');
        }
        return [
