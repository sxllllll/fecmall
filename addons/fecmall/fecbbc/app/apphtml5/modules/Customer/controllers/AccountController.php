 ...
 * @since 1.0
 */
class AccountController extends \fecshop\app\apphtml5\modules\Customer\controllers\AccountController
{
    ...
    public function actionIndex()
    {
        ...
        Yii::$service->page->theme->layoutFile = 'customer_index.php';
        $block = new \fecbbc\app\apphtml5\modules\Customer\block\account\Index;
