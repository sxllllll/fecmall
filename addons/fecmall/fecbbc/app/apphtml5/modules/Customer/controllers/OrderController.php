 ...
 * @since 1.0
 */
class OrderController extends \fecshop\app\apphtml5\modules\Customer\controllers\OrderController
{
    ...
    public function init()
    {
        ...
        Yii::$service->page->theme->layoutFile = 'customer_order.php';
    }
    // 订单列表
    ...
    {
        Yii::$service->page->theme->layoutFile = 'customer_order_detail.php';
        $data = $this->getBlock()->getLastData();
    ...
    public function actionReturnsubmit(){
        ...
        if (!$item_id) {
            Yii::$service->page->message->addError('item id is empty');
