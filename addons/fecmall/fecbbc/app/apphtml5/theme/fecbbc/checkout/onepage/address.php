<div class="main-wrap" id="main-wrap">
    <header id="yoho-header" class="yoho-header boys">
        <a href="<?= Yii::$service->url->getUrl('checkout/onepage') ?>" class="iconfont nav-back">&#xe610;</a>
            ...
            <?php foreach($addresses as $address): ?>
                <div class="address-item" rel="<?=  $address['address_id'] ?>" >
                    ...
                    <div class="action iconfont ">
                        <span class="edit" rel="<?= Yii::$service->url->getUrl('checkout/onepage/addressedit', ['address_id' => $address['address_id']]) ?>">&#xe61e;</span>
                        <span class="del" rel="<?= Yii::$service->url->getUrl('checkout/onepage/addressremove', ['address_id' => $address['address_id']]) ?>">&#xe621;</span>
                    </div>
                </div>
            <?php 		endforeach; ?>
            <?php 	endif; ?>
            <a class="add-address"  href="<?= Yii::$service->url->getUrl('checkout/onepage/addressedit'); ?>">
