<div class="main-wrap" id="main-wrap">
    <header id="yoho-header" class="yoho-header boys">
        <a href="<?= Yii::$service->url->getUrl('checkout/onepage/address') ?>" class="iconfont nav-back">&#xe610;</a>
        <p class="nav-title"><?= Yii::$service->page->translate->__('Edit address');?></p>
    </header>
    <div class="my-address-page yoho-page">
        <div class="tip">
            <?= Yii::$service->page->translate->__('please fill in the address as accurately as possible.');?>
        </div>
        <div class="my-edit-address-page page-wrap" style="min-height: 759px;">
            <?= Yii::$service->page->widget->render('base/flashmessage'); ?>
            <form action="<?= Yii::$service->url->getUrl('checkout/onepage/addressedit', ['address_id' =>$address['address_id'] ]); ?>" method="post" class="edit-address" id="save">
