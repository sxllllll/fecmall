...
<div class="main-wrap" id="main-wrap" >
    <div class="back-email-new-page">
        ...
        <form class="back-email-form" action="<?= Yii::$service->url->getUrl('customer/account/forgotpassword'); ?>" method="post" id="form-validate">
            <?= \fec\helpers\CRequest::getCsrfInputHtml();  ?>
            <div class="form-group phone">
                <label for="phone" class="iconfont">&#xe724;</label>
                <input type="text" name="editForm[phone]" id="phone" placeholder="<?= Yii::$service->page->translate->__('Your Phone');?>"  value="<?= $phone ?>" >
            </div>
            ...
            <button id="backEmailResetBtn" class="back-email-reset-btn" type="button"><?= Yii::$service->page->translate->__('Confirm '); ?></button>
         </form>
    </div>
</div>
<script>
