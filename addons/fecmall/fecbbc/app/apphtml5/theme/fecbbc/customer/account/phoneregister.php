...
<div class="main-wrap" id="main-wrap" >
    <div class="back-email-new-page">
        <div class="top-operation-bar">
            ...
            <span class="page-title"><?= Yii::$service->page->translate->__('绑定手机');?></span>
        </div>
        <?= Yii::$service->page->widget->render('base/flashmessage'); ?>	
        <form  class="back-email-form" action="<?= Yii::$service->url->getUrl('customer/account/phoneregister', [ 'openid' => $openid]); ?>" method="post" id="register-form" >
            ...
            <div class="form-group verify-code">
                ...
                <input type="button" class="obtain generate_code" value=" 获取验证码" style="display: inline-block; padding: 0px 15px;  height: 1rem; position: absolute;  width: 4.5rem;  border: 1px solid #ccc; right: 1.4rem;"/>  
