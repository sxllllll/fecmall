...
<div class="main-wrap" id="main-wrap">
    <header id="yoho-header" class="yoho-header boys">
        ...
        <p class="nav-title">
            <?= Yii::$service->page->translate->__('Order After Sale'); ?>
        </p>
                    ...
                    <li data-id="1315603" class="">
                        ...
                        <div class="fav-info-list">
                            ...
                            <div class="save-price">
                                <input type="button" value="<?= Yii::$service->page->translate->__('Goods Return'); ?>" style="font-size: 0.6rem;width: auto;float: right;margin-right: 0.6rem;"  onclick="javascript:window.location.href='<?= Yii::$service->url->getUrl('customer/order/returnview', ['order_id' => $orderInfo['order_id'],   'item_id' => $product['item_id']]) ?>'" />
