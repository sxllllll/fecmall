 ...
 * @since 1.0
 */
class Payment extends \fecshop\services\Payment
{
     ...
     * 是否是货到付款的支付方式
     */
    public function isCashOnDeliveryMethod($payment_method)
    {
        $methods = $this->getCashOnDeliveryMethods();
