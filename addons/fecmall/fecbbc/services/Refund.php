...
class Refund extends Service
{
    ...
    protected $_adminModelName = '\fecbbc\models\mysqldb\refund\AdminRefund';

    protected $_adminModel;
    
    protected $_bdminModelName = '\fecbbc\models\mysqldb\refund\BdminRefund';
     ...
     */
    public function getByPrimaryKey($primaryKey, $type = "admin")
    {
        $this->initModel($type); 
     ...
     */
    public function coll($filter = '', $type = "admin")
    {
        $this->initModel($type); 
