...
{
    protected $_bdminUserLoginModelName = '\fecbbc\models\mysqldb\bdminUser\BdminUserLogin';

    protected $_bdminUserLoginModel;

    public function init()
    {
        parent::init();
        list($this->_bdminUserLoginModelName, $this->_bdminUserLoginModel) = \Yii::mapGet($this->_bdminUserLoginModelName);
    }
    ...
    {
        $model = new $this->_bdminUserLoginModelName();
